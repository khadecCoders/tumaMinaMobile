              ...
              <TouchableOpacity onPress={() => {
                ...
                <View style={{flexDirection: 'row'}}>
                    ...
                    <View style={{justifyContent: 'space-between'}}>
                          ...
                          <Text numberOfLines={1} style={[STYLES.textNormal, {fontSize: 15, width: 190}]}>{item.received ? <MaterialCommunityIcons color={COLORS.button} name='check-all' size={15}/>:<MaterialCommunityIcons color={COLORS.outline} name='check' size={15}/>}{item.messageText}</Text>
                            :
                          <Text numberOfLines={1} style={[STYLES.textNormal, {fontSize: 15, width: 190}]}>{item.messageText}</Text>
                        }
                    </View>
                </View>
                {/* Time and badge */}
